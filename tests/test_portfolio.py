...
class TestInvestmentPortfolioContract:
    ...
    def test_total_value_returns_positive_number_for_base_case(
        self, sample_portfolio, sample_prices
    ):
    ...
    def test_weights_returns_normalized_dict_and_sums_to_one(
        self, sample_portfolio, sample_prices
    ):
    ...
    def test_missing_price_is_ignored_in_total_value(
        self, sample_portfolio, sample_prices
    ):
        """
    ...
    def test_missing_price_is_ignored_in_weights_calculation(
        self, sample_portfolio, sample_prices
    ):
        """
